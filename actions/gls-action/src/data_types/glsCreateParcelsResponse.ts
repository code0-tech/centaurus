...
@Name({ code: "en-US", content: "Create parcels response" })
@DisplayMessage({ code: "en-US", content: "Create parcels response" })
@Schema(CreateParcelsResponseSchema)
export class GlsCreateParcelsResponseDataType {}
