...
@Identifier("GitHubIssueOpenedWebhook")
...
@Signature("<A extends REST_AUTH_TYPE>(httpSchema: HTTP_SCHEMA, httpURL: HTTP_URL, httpMethod: HTTP_METHOD, httpAuth: A, httpAuthValue: REST_AUTH_VALUE<A>, owner?: TEXT, repository?: TEXT, assignee?: TEXT, input_schema?: githubIssueOpenedWebhookPayload): REST_ADAPTER_INPUT<githubIssueOpenedWebhookPayload>")
@EventSetting({
...
export class GitHubIssueOpenedWebhook extends Rest {}
