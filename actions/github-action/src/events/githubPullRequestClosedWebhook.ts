...
@Signature(
    "<A extends REST_AUTH_TYPE>(httpSchema: HTTP_SCHEMA, httpURL: HTTP_URL, httpMethod: HTTP_METHOD, httpAuth: A, httpAuthValue: REST_AUTH_VALUE<A>, input_schema?: GitHubPullRequestClosedWebhookPayload): REST_ADAPTER_INPUT<GitHubPullRequestClosedWebhookPayload>"
)
@EventSetting({
